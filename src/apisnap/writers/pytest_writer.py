...
def test_"""
            + sanitize_name
            + '''_schema_validation(session, base_url):
...
def test_"""
            + sanitize_name
            + '''_type_validation(session, base_url):
...
def test_"""
            + sanitize_name
            + '''_auth_failure(session, base_url):
    """Auth failure test - if auth required."""
    # Only run if auth is required
    if '''
...
def test_"""
            + sanitize_name
            + '''_wrong_method(session, base_url):
...
def test_"""
            + sanitize_name
            + '''_empty_response(session, base_url):
...
def test_"""
            + sanitize_name
            + '''_content_type(session, base_url):
...
def test_"""
            + sanitize_name
            + '''_boundary_inputs(session, base_url):
